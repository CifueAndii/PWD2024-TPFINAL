...
if(!$sessionValidada || !$session->tienePermiso()){
                ...
                //if ($mostrarProductos){            
                    ...
                    ?>  
                            <li class="nav-item dropdown  ms-3 d-flex align-items-center justify-content-center">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="../Perfil/index.php">Ver Perfil</a></li>
                                    <li>
                            ...
                            <li class="nav-item">
                                <a class="btn text-dark" data-bs-toggle="offcanvas" href="#menu-dinamico" role="button" aria-controls="offcanvas">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" fill="white" class="bi bi-list mb-1" viewBox="0 0 16 16">
                    ...
                    ?>
                            <li class="nav-item  ms-3 d-flex align-items-center justify-content-center">
                                <a data-bs-toggle="modal" href="<?php echo ($sessionIniciada) ? "../carrito/index.php" : "#inicioSesion"  ?>" role="button" aria-controls="modal"><svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" fill="currentColor" class="bi bi-cart3 text-dark" viewBox="0 0 16 16">
