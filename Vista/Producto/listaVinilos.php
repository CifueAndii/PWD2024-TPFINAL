...
background: linear-gradient(360deg, rgba(0,0,0,1) 0%, rgba(0,0,0,1) 0%, rgb(33, 36, 41) 100%);">
    <div class="container px-4 px-lg-5 my-5">
        <div class="text-center text-white">
            <h1 class="display-8 fw-bolder">Vinilos</h1>
                    ...
                    <div class="col mb-5">
                        <div class="card h-100">
                            <div class="ratio ratio-1x1">                            
                                <img class="card-img-top mt-auto" src="<?php echo ($producto["proimg"]); ?>" alt="<?php echo $producto["nombre"]?>">
                            </div>
                            <!-- card body -->
                            ...
                            <!-- card footer -->
                             <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                ...
                                <form action="../Producto/index.php" method="post">
