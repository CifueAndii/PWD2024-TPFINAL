...
<div class="container col-12 my-5 mx-auto w-100 max">
    ...
    <table class="table table-striped table-bordered" id="tabla">
        <thead class="bg-dark text-light">
            ...
            <th field="proartista">Artista</th>
                    ...
                    <div class="modal-body">
                        ...
                        <div id="edit-form">
                            ...
                            <div class="col-12 mb-2">
                                ...
                                <label for="proartista" class="form-label">Artista</label>
                                <input type="text" class="form-control" name="proartista" id="proartista" maxlength="250">
                                <div class="invalid-feedback" id="feedback-artista"></div>
                            </div>
                            <div class="col-12 mb-2">
                                <label for="proprecio" class="form-label">Precio</label>
                                <input type="number" class="form-control" name="proprecio" id="proprecio" min="0">
