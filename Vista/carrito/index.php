...
<div class="container col-12 my-5 mx-auto w-100 max">
    ...
    <button id="confirmarPedido" class="btn btn-primary mx-auto btn-pago" onclick="enviarMail()">Confirmar mi pedido</button>
    <table class="table table-striped table-bordered nowrap text-center" id="tabla">
